...
const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <Link
        to="/how-to-use"
        className="fixed bottom-[88px] left-4 z-50 w-9 h-9 rounded-full bg-background/80 backdrop-blur-xl border border-border shadow-lg flex items-center justify-center hover:bg-primary/10 transition-colors"
