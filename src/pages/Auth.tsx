        ...
        {showContent && (
          ...
          >
            ...
            <motion.p
              ...
              className="text-xs text-muted-foreground italic tracking-wide mb-8"
            >
            ...
            <motion.button
              ...
              className="w-full px-6 py-4 flex items-center justify-center gap-3 rounded-2xl border border-border bg-background/80 backdrop-blur-xl shadow-md hover:shadow-lg transition-all"
